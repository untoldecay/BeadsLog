...
MCP server for [beads](https://github.com/untoldecay/BeadsLog) issue tracker and agentic memory system.
...
### ~~MCP Tools Not Loading in Claude Code~~ (Issue [#346](https://github.com/untoldecay/BeadsLog/issues/346)) - RESOLVED
