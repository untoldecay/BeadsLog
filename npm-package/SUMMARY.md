...
- Constructs URL: `https://github.com/untoldecay/BeadsLog/releases/download/v{VERSION}/beads_{VERSION}_{platform}_{arch}.{ext}`
...
- [beads repository](https://github.com/untoldecay/BeadsLog)
