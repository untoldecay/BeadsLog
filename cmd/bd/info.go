...
var versionChanges = []VersionChange{
	...
	},
	{
		...
		Date:    "2026-08-09",
		Changes: []string{
			"PERF: graph viewer smooth on large graphs (freeze-on-drag, O(1) highlight, min-connections slider)",
			"NEW: generic prose-noise (config/component/service/...) filtered from the graph for both extractors; auto-pruned on each 'bd devlog sync' (self-limiting)",
		},
	},
	{
		Version: "0.60.0",
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: Auto-Metadata Extraction - tool parses Subject/Problem from Markdown",
			"NEW: File Collision Check - prevents double-registering the same file",
			"NEW: Agent-Proofing - louder AI directives and improved maintenance visibility",
		},
	},
	{
		Version: "0.52.0",
